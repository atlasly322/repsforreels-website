...
<div class="flex items-center gap-2">
	...
	<button
		onclick={() => openShare('x')}
		class="p-2 rounded-lg bg-surface/50 border border-white/5 text-text-secondary hover:border-white/50 hover:text-white transition-all backdrop-blur-sm"
	...
	<button
		...
		class="p-2 rounded-lg bg-surface/50 border border-white/5 text-text-secondary hover:border-[#1877F2]/50 hover:text-[#1877F2] transition-all backdrop-blur-sm"
	...
	<button
		...
		class="p-2 rounded-lg bg-surface/50 border border-white/5 text-text-secondary hover:border-[#FF4500]/50 hover:text-[#FF4500] transition-all backdrop-blur-sm"
	...
	<button
		...
		class="p-2 rounded-lg bg-surface/50 border border-white/5 text-text-secondary hover:border-[#25D366]/50 hover:text-[#25D366] transition-all backdrop-blur-sm"
