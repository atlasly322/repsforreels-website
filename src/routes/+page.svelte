		...
		<div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
			...
			<div class="text-center lg:text-left">
				...
				<div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
					<!-- App Store Badge -->
					<a href="#download" class="group inline-flex items-center gap-3 px-5 py-2.5 bg-black text-white rounded-lg border border-white/30 hover:bg-white/10 transition-all hover:scale-105">
						<svg class="w-7 h-7" fill="currentColor" viewBox="0 0 24 24"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
						<div class="text-left">
							<div class="text-[9px] font-normal leading-tight">Download on the</div>
							<div class="text-lg font-semibold leading-tight -mt-0.5">App Store</div>
						</div>
					</a>
					<!-- Google Play Badge -->
					<a href="#download" class="group inline-flex items-center gap-3 px-5 py-2.5 bg-black text-white rounded-lg border border-white/30 hover:bg-white/10 transition-all hover:scale-105">
						<svg class="w-6 h-6" viewBox="0 0 24 24">
							...
							<path fill="#34A853" d="M5.144 21.59l8.427-8.402-2.137-2.154L5.133 4.489a.997.997 0 0 0-1.128-.063L18.099 15.514l-3.919 2.218z"/>
							<path fill="#FBBC04" d="M18.099 15.514l-8.427 8.402L4.005 21.527a.997.997 0 0 1-.197-.592v-16.87c0-.201.063-.394.18-.555z"/>
							<path fill="#EA4335" d="M14.099 12l2.137-2.154 3.919 2.218L18.099 15.514l-4-3.514z"/>
							<path fill="#34A853" d="M4.005 4.482L14.099 12l-2.137 2.154-8.427-8.402c.117-.161.286-.291.47-.27z"/>
						</svg>
						<div class="text-left">
							<div class="text-[9px] font-normal leading-tight tracking-wider uppercase">Get it on</div>
							<div class="text-lg font-semibold leading-tight -mt-0.5">Google Play</div>
						</div>
					</a>
				</div>
...
<section id="download" class="py-24 relative overflow-hidden z-10">
	...
	<div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
		...
		<div class="flex flex-col sm:flex-row gap-4 justify-center">
			<!-- App Store Badge -->
			<a href="#" class="group inline-flex items-center gap-3 px-6 py-3 bg-black text-white rounded-xl border border-white/20 hover:bg-white/10 transition-all hover:scale-105">
				<svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
				<div class="text-left">
					<div class="text-[10px] font-normal leading-tight">Download on the</div>
					<div class="text-xl font-semibold leading-tight -mt-0.5">App Store</div>
				</div>
			</a>
			<!-- Google Play Badge -->
			<a href="#" class="group inline-flex items-center gap-3 px-6 py-3 bg-black text-white rounded-xl border border-white/20 hover:bg-white/10 transition-all hover:scale-105">
				...
				<div class="text-left">
					<div class="text-[10px] font-normal leading-tight tracking-wider uppercase">Get it on</div>
					<div class="text-xl font-semibold leading-tight -mt-0.5">Google Play</div>
				</div>
			</a>
		</div>
	</div>
